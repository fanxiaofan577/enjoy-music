 ...
 * @Description: 重写ImageView
 * 来自github("https://github.com/shehuan/NiceImageView/blob/master/niceimageview/src/main/java/com/shehuan/niv/NiceImageView.java")
 * 修复RecyclerView中圆角时有时无问题：添加第168行
 * @Date: 2022/4/7 17:47
 * @Author: fanxiaofan
 */
public class NiceImageView extends AppCompatImageView {
    ...
    private int borderColor = Color.parseColor("#ffffffff"); // 边框颜色
    private int innerBorderWidth; // 内层边框宽度
    private int innerBorderColor = Color.parseColor("#ffffffff");  // 内层边框充色
