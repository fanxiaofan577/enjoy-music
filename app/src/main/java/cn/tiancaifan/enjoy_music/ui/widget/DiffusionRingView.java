    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if (list.get(i).enable) {
                ...
                ViewUtils.calcPoint(centerPoint.x, centerPoint.y, list.get(i).radius, list.get(i).angle, list.get(i).point);
