...
public class PlayPauseView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mBorderWidth = SizeUtils.dp2px(context, ta.getDimension(R.styleable.PlayPauseView_border_width1, 2));
        ...
        mLoadingColor = ta.getColor(R.styleable.PlayPauseView_loadingColor, mRingColor);
        ta.recycle();
