package cn.tiancaifan.enjoy_music.utils.download.dbcontrol;
...
public class FileHelper {
    private static String userID = "enjoyMusic";
    private static String baseFilePath = Environment.getExternalStorageDirectory().getAbsolutePath()+ "/filedownloader";
